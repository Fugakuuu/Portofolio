...
const PORTRAIT_SRC = "/Personal.webp";
      ...
      <div className="mx-auto w-full max-w-275 px-6 pt-44 pb-24 sm:px-10 sm:pt-56 sm:pb-32">
        <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-8">
          <FadeIn className="flex flex-col gap-4">
            ...
            <h1 className="text-[2.25rem] font-medium leading-[1.05] tracking-tight text-foreground md:text-[2.5rem] lg:text-[3rem]">
            ...
            <p className="max-w-[34ch] text-[18px] leading-[1.4] tracking-tight text-foreground/65">
              Passionate solving technical challenges and creating intuitive web experiences.
            </p>
            <HeroCtas />
          </FadeIn>
